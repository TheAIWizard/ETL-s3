...
def update_project():
    service_endpoint = "https://user-nrandriamanana-label-studio.user.lab.sspcloud.fr"
    authorization_token = ""
    # headers
    headers = {
        "Content-Type": "application/json",
    ...
    payload_update_project = {
        ...
        "title": "Lot 4 update",
        "description": "Série en cours - Opération qualité FastText (NAF 2008) - Campagne d'annotation des libellés d'activités: ",
        "label_config": xml_template,
        "expert_instruction": instructions,
        "show_instruction": True,
        "show_skip_button": True,
    ...
    # Create new s3 storage for annotation source
    url_get_project = f"{service_endpoint}/api/projects/6/"
